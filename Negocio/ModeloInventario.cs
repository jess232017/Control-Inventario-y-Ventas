...
namespace Negocio
{
    public class ModeloInventario : IModelo
	{
		private readonly RepositorioInventario repositorio;
		public EInventario Entidad { get; set; }
        ...
        {
			repositorio = new RepositorioInventario();
			Entidad = new EInventario();
		}
		...
		public EInventario LeerEntidad()
		{
			try
			{
				Exito = true;
		...
		public List<EInventario> LeerLista()
		{
			try
			{
				Exito = true;
