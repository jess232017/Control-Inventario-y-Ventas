...
namespace Negocio
{
    public class ModeloTienda : IModelo
	{
		private readonly RepositorioTienda repositorio;
		public ETienda Entidad { get; set; }
        ...
        public ModeloTienda()
        {
			repositorio = new RepositorioTienda();
			Entidad = new ETienda();
		}
