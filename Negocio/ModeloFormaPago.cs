...
namespace Negocio
{
    public class ModeloFormaPago : IModelo
	{
		private readonly RepositorioFormaPago repositorio;
		public EFormaPago Entidad { get; set; }
		public string Mensaje { get; set; }
		public Accion Accion { get; set; }
		public bool Exito { get; set; }

        public ModeloFormaPago()
        {
			repositorio = new RepositorioFormaPago();
			Entidad = new EFormaPago();
		}
		...
		public List<EFormaPago> LeerLista()
		{
			try
			{
				Exito = true;
