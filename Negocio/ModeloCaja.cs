...
namespace Negocio
{
    public class ModeloCaja : IModelo
	{
		private readonly RepositorioCaja repositorio;
		public ECaja Entidad { get; set; }
        ...
        public ModeloCaja()
        {
			repositorio = new RepositorioCaja();
			Entidad = new ECaja();
		}
