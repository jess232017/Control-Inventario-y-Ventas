...
namespace Negocio
{
    public class ModeloRol : IModelo
	{
		private readonly RepositorioRol repositorio;
		public ERol Entidad { get; set; }
        ...
        public ModeloRol()
        {
			repositorio = new RepositorioRol();
			Entidad = new ERol();
		}
